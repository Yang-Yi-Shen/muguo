...
const itemList = [
    {
        name_ch: "綜合禮盒",
        image: "/src/assets/cake_collection.jpeg",
    ...
    {
        name_ch: "蛋黃酥",
        image: "/src/assets/egg_yolk_cake.jpeg",
    ...
    {
        name_ch: "菠蘿蛋黃酥",
        image: "/src/assets/carrot_egg_yolk_cake.jpeg",
    ...
    {
        name_ch: "綜合芋頭酥",
        image: "/src/assets/taro_cake.jpeg",
    ...
    {
        name_ch: "鳳梨酥、蔓越莓酥1",
        image: "/src/assets/pineapple_cake.jpeg",
    ...
    {
        name_ch: "經典酥餅",
        image: "/src/assets/flatcakes.png",
...
<template>
    ...
    <main>
        <RouterLink :to="`/products/${currentItem.link}`" class="item-image-wrapper">
            <img class="item-image" :src="currentItem.image">
        </RouterLink>
        <div class="item-text">
